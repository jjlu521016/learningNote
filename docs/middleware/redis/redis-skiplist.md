...
skiplist的插入流程如下
![Skip_list_add_element-en.gif](../../_media/images/redis-skiplist/Skip_list_add_element-en.gif)
...
时间复杂度O(logn)
插入节点的流程如下：
![image.png](../../_media/images/redis-skiplist/24f2c880-dad9-11e9-820b-5b2353445520.png)
```c
